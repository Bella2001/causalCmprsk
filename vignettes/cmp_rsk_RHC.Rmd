...
We will illustrate how to use `causalCmprsk` package by analyzing data from an observational study on right heart catheterization (RHC) procedure. The data were obtained from http://hbiostat.org/data/ courtesy of the Vanderbilt University Department of Biostatistics.
